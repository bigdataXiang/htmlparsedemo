...
public class WaterShutoffNotice {
	...
	public static String waterNotice(String url,String folder){
		String poi="";
			try {
				...
				if (content == null) {
				    ...
				    NodeFilter filter = new AndFilter(new TagNameFilter("table"),new HasAttributeFilter("style", "margin:20px 0px;"));
